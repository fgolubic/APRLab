...
public:
	...
	*/
	...
	/**
		Method that calculates first derivatives of given function in given point.
		Every inherited class implements analyticaly defined first  derivative.
	*/
	virtual std::vector<double> firstDerivative(std::vector<double> x) = 0;

	/**
		Return Hess matrix for function in given point.
	*/
	virtual Matrix hess(std::vector<double> x) = 0;
	/**
