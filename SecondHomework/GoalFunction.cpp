...
void GoalFunction::getUnimodal(double h, double point, double & l, double & r, int dimension , int index )
{
	...
	if (fm < fr && fm < fl) {
		...
		do
		{
			...
			std::cout << "Value of left boundary: " << l << std::endl;
			std::cout << "Value of right boundary: " << r << std::endl;
			std::cout << "Value of function in right: " << fr << std::endl;
		...
		do
		{
			...
			std::cout << "Value of left boundary: " << l << std::endl;
			std::cout << "Value of right boundary: " << r << std::endl;
			std::cout << "Value of function in left: " << fl << std::endl;
		} while (fm > fl);
}
...
double GoalFunction::goldenCut(double a, double b, double e, int dimension , int index )
{
	...
	std::cout << "Value of a, b, c and d respectively: " << a << b << c << d << std::endl;
	std::cout << " Value of fc and fd: " << fc << fd<< std::endl;
	while((b - a) > e) {
		step++;
		if(fc < fd) {
			b = d;
...
bool GoalFunction::nelderMeadContinuation(std::vector<std::vector<double>> simplex, std::vector<double> xC, double e)
{
	...
	if (criteriaResult <= e) return true;
